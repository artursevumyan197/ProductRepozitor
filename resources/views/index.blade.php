    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="{{ route('api/v1/openLog') }}">Войти</a></li>
    ...
    <div class="starter-template">
        ...
        <form method="GET" action="http://internet-shop.tmweb.ru">
            <div class="filters row">
                ...
                <div class="col-sm-6 col-md-3">
                    <button type="submit" class="btn btn-prirmay">Фильтр</button>
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <form action="http://internet-shop.tmweb.ru/basket/add/1" method="POST">
                            ...
                            <input type="hidden" name="_token" value="a6SfmkMdXj6iKXdgMoPGw2fqEEpSi6dnKVK1J5o6">            </form>
                        </p>
                    </div>
                </div>
            </div>
